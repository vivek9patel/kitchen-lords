...
export default function Header({ chef_name }: { chef_name: string }) {

    return (
        <div className="navbar bg-base-100">
        <div className="flex-1">
            <a className="btn btn-ghost text-xl capitalize">{chef_name+"'s"} kitchens</a>
        </div>
        <div className="flex-none">
            ...
            <div className="avatar placeholder">
                <div className="bg-neutral text-neutral-content rounded-full w-12">
                    <span className="text-xl">{getInitials(chef_name)}</span>
                </div>
            </div> 
            </div>
        </div>
